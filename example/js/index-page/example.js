...
var require_base64 = __commonJS({
    "node_modules/@protobufjs/base64/index.js"(exports2) {
        ...
        base64.length = function length(string) {
            ...
            if (!p2) return 0;
            var n2 = 0;
            while (--p2 % 4 > 1 && string.charAt(p2) === "=") ++n2;
        ...
        base64.encode = function encode(buffer, start, end) {
            ...
            if (parts) {
                if (i2)
                    parts.push(
                        String.fromCharCode.apply(String, chunk.slice(0, i2)),
                    );
                return parts.join("");
            }
        ...
        base64.decode = function decode(string, buffer, offset) {
            ...
            for (var i2 = 0; i2 < string.length; ) {
                ...
                if (c2 === 61 && j > 1) break;
                if ((c2 = s64[c2]) === void 0) throw Error(invalidEncoding);
                switch (j) {
                    case 0:
                        t2 = c2;
                        j = 1;
        ...
        function factory(exports3) {
            if (typeof Float32Array !== "undefined")
                (function () {
                    ...
                    exports3.readFloatLE = le
                        ? readFloat_f32_cpy
                        : readFloat_f32_rev;
                    exports3.readFloatBE = le
                        ? readFloat_f32_rev
                        : readFloat_f32_cpy;
                })();
            else
                (function () {
                    function writeFloat_ieee754(writeUint, val, buf, pos) {
                        ...
                        if (val === 0)
                            ...
                            writeUint(
                                ((sign << 31) |
                                    Math.round(val / 1401298464324817e-60)) >>>
                                    0,
                                buf,
                                pos,
                            );
                            ...
                            var exponent = Math.floor(Math.log(val) / Math.LN2),
                                mantissa =
                                    Math.round(
                                        val * Math.pow(2, -exponent) * 8388608,
                                    ) & 8388607;
                            writeUint(
                                ((sign << 31) |
                                    ((exponent + 127) << 23) |
                    ...
                    exports3.writeFloatLE = writeFloat_ieee754.bind(
                        null,
                        writeUintLE,
                    );
                    exports3.writeFloatBE = writeFloat_ieee754.bind(
                        null,
                        writeUintBE,
                    );
                    ...
                    exports3.readFloatLE = readFloat_ieee754.bind(
                        null,
                        readUintLE,
                    );
                    exports3.readFloatBE = readFloat_ieee754.bind(
                        null,
                        readUintBE,
                    );
                })();
    ...
    "node_modules/protobufjs/src/util/minimal.js"(exports2) {
        ...
        util.Buffer = (function () {
            try {
                ...
                return Buffer3.prototype.utf8Write
                    ? Buffer3
                    : /* istanbul ignore next */
                      null;
            } catch (e) {
        ...
        util._configure = function () {
            ...
            util._Buffer_from =
                (Buffer3.from !== Uint8Array.from &&
                    Buffer3.from) /* istanbul ignore next */ ||
                function Buffer_from(value, encoding) {
                    return new Buffer3(value, encoding);
                };
            util._Buffer_allocUnsafe =
                Buffer3.allocUnsafe /* istanbul ignore next */ ||
...
var require_reader = __commonJS({
    "node_modules/protobufjs/src/reader.js"(exports2, module2) {
        ...
        Reader.prototype.uint32 =
            /* @__PURE__ */ (function read_uint32_setup() {
        ...
        function readLongVarint() {
            ...
            if (this.len - this.pos > 4) {
                for (; i < 4; ++i) {
                    bits.lo =
                        (bits.lo | ((this.buf[this.pos] & 127) << (i * 7))) >>>
                        0;
        ...
        Service.prototype.rpcCall = function rpcCall(
            ...
            try {
                return self2.rpcImpl(
                    method,
                    requestCtor[
                        self2.requestDelimited ? "encodeDelimited" : "encode"
                    ](request).finish(),
                    function rpcCallback(err3, response) {
                        if (err3) {
    ...
    "node_modules/@protobufjs/fetch/index.js"(exports2, module2) {
        ...
        function fetch2(filename, options, callback) {
            ...
            if (!options.xhr && fs && fs.readFile)
                return fs.readFile(
                    filename,
                    function fetchReadFileCallback(err3, contents) {
                        return err3 && typeof XMLHttpRequest !== "undefined"
                            ? fetch2.xhr(filename, options, callback)
                            : err3
                              ? callback(err3)
                              : callback(
                                    null,
            ...
            if (found) {
                ...
                for (var i = 0; i < this.nestedArray.length; ++i)
                    if (
                        ...
                        (found = this._nestedArray[i]._lookupImpl(
                            path,
                            flatPath,
                        ))
                    )
...
var require_service2 = __commonJS({
    "node_modules/protobufjs/src/service.js"(exports2, module2) {
        ...
        Service.fromJSON = function fromJSON(name, json2) {
            ...
            if (json2.methods)
                for (
                    var names = Object.keys(json2.methods), i = 0;
                    i < names.length;
                    ++i
                )
                    service.add(
                        Method.fromJSON(names[i], json2.methods[names[i]]),
                    );
            if (json2.nested) service.addJSON(json2.nested);
            if (json2.edition) service._edition = json2.edition;
        ...
        Service.prototype._resolveFeaturesRecursive =
            function _resolveFeaturesRecursive(edition) {
                if (!this._needsRecursiveFeatureResolution) return this;
                edition = this._edition || edition;
                Namespace.prototype._resolveFeaturesRecursive.call(
                    this,
                    edition,
                );
        ...
        function decoder(mtype) {
            var gen = util.codegen(
                ...
                "var c=l===undefined?r.len:r.pos+l,m=new this.ctor" +
                    (mtype.fieldsArray.filter(function (field2) {
                        return field2.map;
                    }).length
                        ? ",k,value"
                        : ""),
...
var require_type = __commonJS({
    "node_modules/protobufjs/src/type.js"(exports2, module2) {
        ...
        Type.fromJSON = function fromJSON(name, json2) {
            ...
            var names = Object.keys(json2.fields),
                i = 0;
            for (; i < names.length; ++i)
                type.add(
                    (typeof json2.fields[names[i]].keyType !== "undefined"
                        ? MapField.fromJSON
                        : Field.fromJSON)(names[i], json2.fields[names[i]]),
                );
            if (json2.oneofs)
                for (
                    names = Object.keys(json2.oneofs), i = 0;
                    i < names.length;
                    ++i
                )
            ...
            if (json2.nested)
                for (
                    names = Object.keys(json2.nested), i = 0;
                    i < names.length;
                    ++i
                ) {
            ...
            if (json2.reserved && json2.reserved.length)
                type.reserved = json2.reserved;
            if (json2.group) type.group = true;
            if (json2.comment) type.comment = json2.comment;
            if (json2.edition) type._edition = json2.edition;
        ...
        Type.prototype._resolveFeaturesRecursive =
            function _resolveFeaturesRecursive(edition) {
                if (!this._needsRecursiveFeatureResolution) return this;
                edition = this._edition || edition;
                Namespace.prototype._resolveFeaturesRecursive.call(
...
var require_root = __commonJS({
    "node_modules/protobufjs/src/root.js"(exports2, module2) {
        ...
        Root.fromJSON = function fromJSON(json2, root2) {
            ...
            if (json2.options) root2.setOptions(json2.options);
            return root2.addJSON(json2.nested).resolveAll();
        };
        ...
        Root.prototype.load = function load(filename, options, callback) {
            ...
            function fetch2(filename2, weak) {
                ...
                if (sync) {
                    ...
                    ++queued;
                    self2.fetch(filename2, function (err3, source2) {
                        --queued;
                        if (!callback) {
                            return;
                        }
    ...
    "node_modules/protobufjs/src/util.js"(exports2, module2) {
        ...
        Object.defineProperty(util, "decorateRoot", {
            get: function () {
                return (
                    roots["decorated"] ||
                    (roots["decorated"] = new (require_root())())
                );
            },
        });
    },
...
var require_field = __commonJS({
    "node_modules/protobufjs/src/field.js"(exports2, module2) {
        ...
        Field.fromJSON = function fromJSON(name, json2) {
            ...
            if (json2.edition) field._edition = json2.edition;
        ...
        Field.prototype._inferLegacyProtoFeatures =
...
var require_object = __commonJS({
    "node_modules/protobufjs/src/object.js"(exports2, module2) {
        ...
        ReflectionObject.prototype._inferLegacyProtoFeatures =
            function _inferLegacyProtoFeatures() {
                return {};
            };
...
var require_enum = __commonJS({
    "node_modules/protobufjs/src/enum.js"(exports2, module2) {
        ...
        Enum.fromJSON = function fromJSON(name, json2) {
            ...
            if (json2.edition) enm._edition = json2.edition;
...
var require_index_light = __commonJS({
    "node_modules/protobufjs/src/index-light.js"(exports2, module2) {
        ...
        function load(filename, root2, callback) {
            ...
            } else if (!root2) root2 = new protobuf2.Root();
            return root2.load(filename, callback);
        }
        protobuf2.load = load;
        function loadSync(filename, root2) {
            if (!root2) root2 = new protobuf2.Root();
        ...
        protobuf2.Namespace._configure(
            protobuf2.Type,
            protobuf2.Service,
            protobuf2.Enum,
        );
        ...
        function tokenize(source, alternateCommentMode) {
            ...
            function setComment(start, end, isLeading) {
                ...
                do {
                    if (
                        --commentOffset < 0 ||
                        (c2 = source.charAt(commentOffset)) === "\n"
                    ) {
                ...
                do {
                    ...
                    if (charAt(offset) === "/") {
                        ...
                        if (charAt(offset) === "/") {
                            ...
                            start = offset + 1;
                            isDoc =
                                alternateCommentMode || charAt(start) === "*";
                            do {
                                if (curr === "\n") {
                                    ++line;
                                }
    ...
    "node_modules/protobufjs/src/parse.js"(exports2, module2) {
        ...
        function parse(source, root2, options) {
            ...
            function parsePackage() {
                if (pkg2 !== void 0) throw illegal("package");
                pkg2 = next();
                if (!typeRefRe.test(pkg2)) throw illegal(pkg2, "name");
                ptr = ptr.define(pkg2);
                skip(";");
            }
            ...
            function parseEnumValue(parent, token2) {
                ...
                dummy.setOption = function (name, value2) {
                    ReflectionObject.prototype.setOption.call(
                        dummy,
                        name,
                        value2,
                    );
    ...
    "node_modules/protobufjs/src/common.js"(exports2, module2) {
        ...
        function common(name, json2) {
            if (!commonRe.test(name)) {
                ...
                json2 = {
                    nested: {
                        google: { nested: { protobuf: { nested: json2 } } },
                    },
                };
            }
            common[name] = json2;
...
// src/polyfills.js
import { URL as WHATWG_URL } from "whatwg_url";
import * as wasiHttp from "http";
import {
    TextEncoder as TextEncoder2,
    TextDecoder as TextDecoder2,
} from "encoding";
import { Buffer as Buffer2 } from "buffer";
import * as std from "std";
var internalLog = (level, ...args) => {
    const message = args
        .map((arg) => {
...
var Response2 = class {
    constructor(body, init = {}) {
        ...
        let headerInit = init.headers;
        if (!headerInit && body && body.headers) {
            headerInit = body.headers;
        }
        this.headers = new Headers(headerInit || {});
    }
    get ok() {
    ...
    async text() {
        if (this._body && typeof this._body.arrayBuffer === "function") {
            const buf = await this._body.arrayBuffer();
            return new TextDecoder2().decode(buf);
        }
        if (this._body instanceof Uint8Array)
            return new TextDecoder2().decode(this._body);
        return typeof this._body === "object"
            ? JSON.stringify(this._body)
            : String(this._body || "");
    }
    async json() {
        const t2 = await this.text();
    ...
    async arrayBuffer() {
        ...
        const t2 = await this.text();
        return new TextEncoder2().encode(t2).buffer;
    }
};
...
globalThis.Request = wasiHttp.Request;
globalThis.Buffer = Buffer2;
globalThis.console = {
    log: (...args) => internalLog("[LOG]", ...args),
    error: (...args) => internalLog("[ERROR]", ...args),
    warn: (...args) => internalLog("[WARN]", ...args),
    info: (...args) => internalLog("[INFO]", ...args),
};
if (typeof globalThis.atob === "undefined") {
    globalThis.atob = (str) => Buffer2.from(str, "base64").toString("binary");
}
if (typeof globalThis.btoa === "undefined") {
    globalThis.btoa = (str) => Buffer2.from(str, "binary").toString("base64");
}

// node_modules/itty-router/index.mjs
var t = ({ base: e = "", routes: t2 = [], ...r2 } = {}) => ({
    __proto__: new Proxy(
        {},
        {
            get:
    ...
    async fetch(e2, ...o2) {
        let a2,
            s2,
            c2 = new URL(e2.url),
            n2 = (e2.query = { __proto__: null });
        for (let [e3, t3] of c2.searchParams)
            n2[e3] = n2[e3] ? [].concat(n2[e3], t3) : t3;
        e: try {
            for (let t3 of r2.before || [])
                if (null != (a2 = await t3(e2.proxy ?? e2, ...o2))) break e;
            t: for (let [r3, n3, l, i] of t2)
                if (
                    (r3 == e2.method || "ALL" == r3) &&
                    (s2 = c2.pathname.match(n3))
                ) {
...
var s = (e = 500, t2) => {
    ...
    return (
        (t2 = {
            status: e,
            ...("object" == typeof t2 ? t2 : { error: t2 || a(e) }),
        }),
        o(t2, { status: e })
    );
};
var c = (e) => {
    e.proxy = new Proxy(e.proxy ?? e, {
        get: (t2, r2) => t2[r2]?.bind?.(e) ?? t2[r2] ?? t2?.params?.[r2],
    });
};
var n = ({
    format: e = o,
...
if (typeof TextEncoder === "undefined") {
    globalThis.TextEncoder = class {
        encode(str) {
            return new Uint8Array(str.split("").map((c2) => c2.charCodeAt(0)));
        }
    };
}
...
var root = protobuf.Root.fromJSON({
    nested: {
        HeaderFields: {
            fields: { fields: { rule: "repeated", type: "string", id: 1 } },
        },
        StringSlice: {
            fields: { fields: { rule: "repeated", type: "string", id: 1 } },
        },
        FDRequest: {
            fields: {
                ...
                header: { keyType: "string", type: "HeaderFields", id: 2 },
                body: { type: "bytes", id: 3 },
                content_length: { type: "int64", id: 4 },
                transfer_encoding: { type: "StringSlice", id: 5 },
                host: { type: "string", id: 6 },
                remote_addr: { type: "string", id: 7 },
                request_uri: { type: "string", id: 8 },
                pattern: { type: "string", id: 9 },
            },
        },
        FDResponse: {
            fields: {
                body: { type: "bytes", id: 1 },
                status_code: { type: "int32", id: 2 },
...
var FDRequest = root.lookupType("FDRequest");
function normalizeHeaders(rawHeaders) {
    ...
    for (const key in rawHeaders) {
        ...
        if (value && typeof value === "object" && Array.isArray(value.fields)) {
            ...
            normalized[cleanKey] = { fields: value.map(String) };
        } else {
            normalized[cleanKey] = { fields: [String(value)] };
        }
    }
    return normalized;
}
function marshalResponse(data) {
    const payload = {
        ...data,
        // Automatically fix the header mapping
        header: normalizeHeaders(data.header),
    };
    const errMsg = FDResponse.verify(payload);
    if (errMsg) throw new Error(`FDResponse verify failed: ${errMsg}`);
    const message = FDResponse.create(payload);
    return FDResponse.encode(message).finish();
}
function unmarshalRequest(buffer) {
    const message = FDRequest.decode(buffer);
    return FDRequest.toObject(message, {
        longs: String,
        // Treat int64 as strings to avoid precision loss in JS
        enums: String,
        bytes: Uint8Array,
    });
}
...
function readStdinToBuffer() {
    ...
    const tempBuf = new ArrayBuffer(CHUNK_SIZE);
    while (true) {
        const bytesRead = std2.in.read(tempBuf, 0, CHUNK_SIZE);
        if (bytesRead <= 0) break;
        const newBuffer = new Uint8Array(totalBuffer.length + bytesRead);
        newBuffer.set(totalBuffer);
        newBuffer.set(
            new Uint8Array(tempBuf, 0, bytesRead),
            totalBuffer.length,
        );
...
var createResponse = (contentType, transformer = (v) => v) => {
    return (body, options = {}) => {
        const transformedBody = transformer(body);
        ...
        return new Response(transformedBody, responseOptions);
    };
};
var json = createResponse("application/json", JSON.stringify);
var html = createResponse("text/html; charset=utf-8");
var text = createResponse("text/plain");
var binary = createResponse("application/octet-stream");
var raw = (body, options = {}) => {
    const responseOptions = {
        ...options,
        headers: {
...
// src/app.js
function createIgnisApp() {
    const router = n();
    const handle = async () => {
        try {
            const rawIn = readStdinToBuffer();
            if (rawIn.length === 0) return;
            const fdReq = unmarshalRequest(rawIn);
            let fullUri = fdReq.request_uri || "/";
            if (!fullUri.startsWith("http")) {
                fullUri = `http://${fdReq.host || "localhost"}${fullUri}`;
            }
            const ittyReq = {
                method: fdReq.method,
                url: new URL(fullUri).href,
                headers: {},
                content: fdReq.body,
                query: Object.fromEntries(new URL(fullUri).searchParams),
            };
            if (fdReq.header) {
                for (const k in fdReq.header) {
                    ittyReq.headers[k.toLowerCase()] =
                        fdReq.header[k].fields[0];
                }
            }
            let result = await router.fetch(ittyReq);
            let resPayload = {
                status_code: 200,
            ...
            if (result instanceof Response) {
                resPayload.status_code = result.status;
                result.headers.forEach((v, k) => {
                    resPayload.header[k.toLowerCase()] = v;
                });
                resPayload.body = new Uint8Array(await result.arrayBuffer());
            } else {
                resPayload.body = new TextEncoder().encode(
                    JSON.stringify(result),
                );
                resPayload.header["content-type"] = "application/json";
            }
            resPayload.header["content-length"] =
                resPayload.body.length.toString();
            resPayload.header["x-powered-by"] = "ignis-runtime";
            const binary2 = marshalResponse(resPayload);
            std3.out.write(
                binary2.buffer,
                binary2.byteOffset,
                binary2.byteLength,
            ...
            console.error("Critical SDK Error:", err3);
            const errBin = marshalResponse({
                status_code: 500,
                body: new TextEncoder().encode(
                    JSON.stringify({ error: err3.message }),
                ),
                header: { "content-type": "application/json" },
            });
            std3.out.write(errBin.buffer, errBin.byteOffset, errBin.byteLength);
            std3.out.flush();
        }
    };
    return {
...
// examples/main.js
var app = createIgnisApp();
var Users = {
    1: { id: 1, username: "FastTiger123", created_at: "2023-08-14T15:30:00Z" },
    2: { id: 2, username: "CleverEagle99", created_at: "2023-11-07T10:15:00Z" },
    3: { id: 3, username: "BraveWolf42", created_at: "2024-02-19T20:45:00Z" },
};
var baseStyles = `
<style>
    body { font-family: 'Inter', sans-serif; background: #f4f7f9; color: #2d3748; padding: 40px; }
    ...
    th { text-align: left; background: #f8fafc; padding: 12px; color: #64748b; font-size: 0.85rem; text-transform: uppercase; }
...
app.get("/api/v1/", () => {
    const routes = [
        { method: "GET", path: "/api/v1/", desc: "This documentation page" },
        {
            method: "GET",
            path: "/api/v1/user",
        ...
        },
        {
            method: "GET",
            path: "/api/v1/user/1",
            // Link to a specific ID for the demo
            displayPath: "/api/v1/user/:id",
            desc: "Retrieve a specific user (e.g., User 1)",
        },
        { method: "GET", path: "/api/v1/joke", desc: "Get a random dad joke" },
    ];
    const rows = routes
        .map(
            (r2) => `
        <tr>
            <td><span class="badge method-get">${r2.method}</span></td>
            <td>
                <a href="${r2.path}" style="text-decoration: none;">
                    <code>${r2.displayPath || r2.path}</code>
                </a>
            </td>
            <td>${r2.desc}</td>
        </tr>
    ...
    return html(`
        ...
        <html>
        <head>
            <title>Ignis API Docs</title>
            ${baseStyles}
            <style>
                a code { color: #3182ce; transition: color 0.2s; }
                a code:hover { color: #2c5282; text-decoration: underline; }
            </style>
        </head>
        <body>
            <div class="container">
                <h1>\u{1F525} Ignis Runtime (Javascript)</h1>
                <table>
...
app.get("/api/v1/joke", async () => {
    try {
        ...
        return error(500, `Could not fetch joke from external API: ${e}`);
    }
});
app.run();
