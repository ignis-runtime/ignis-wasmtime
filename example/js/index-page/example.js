  ...
  "node_modules/@protobufjs/fetch/index.js"(exports2, module2) {
    ...
    function fetch2(filename, options, callback) {
      ...
      if (!options.xhr && fs && fs.readFile)
        return fs.readFile(filename, function fetchReadFileCallback(err3, contents) {
          return err3 && typeof XMLHttpRequest !== "undefined" ? fetch2.xhr(filename, options, callback) : err3 ? callback(err3) : callback(null, options.binary ? contents : contents.toString("utf8"));
        });
...
import { TextEncoder as TextEncoder2, TextDecoder as TextDecoder2 } from "encoding";
...
var Response2 = class {
  ...
  async text() {
    ...
    return typeof this._body === "object" ? JSON.stringify(this._body) : String(this._body || "");
  }
  async json() {
...
function marshalResponse(data) {
  ...
  if (errMsg)
    throw new Error(`FDResponse verify failed: ${errMsg}`);
...
var html = createResponse("text/html");
    ...
    try {
      ...
      if (fdReq.header) {
        for (const k in fdReq.header) {
          ittyReq.headers[k.toLowerCase()] = fdReq.header[k].fields[0];
        }
      }
      ...
      resPayload.header["content-length"] = resPayload.body.length.toString();
      resPayload.header["x-powered-by"] = "ignis-runtime";
      const binary2 = marshalResponse(resPayload);
      std3.out.write(binary2.buffer, binary2.byteOffset, binary2.byteLength);
      std3.out.flush();
    } catch (err3) {
